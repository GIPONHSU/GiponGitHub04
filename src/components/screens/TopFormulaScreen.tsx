    ...
    <div className="absolute inset-0 bg-slate-900 flex flex-col p-8 font-sans overflow-auto">
      ...
      >
        <div className="bg-slate-950 p-6 flex items-center justify-between border-b border-slate-700 shrink-0">
          <div>
            <h2 className="text-4xl font-bold text-cyan-400">陀螺計算公式 (Top Formula)</h2>
            <p className="text-slate-400 text-lg mt-2">陀螺基本參數與戰鬥破壞判定公式說明</p>
          </div>
          <button
            onClick={onBack}
        ...
        <div className="p-8 flex-1 overflow-auto space-y-8 text-slate-300">
          ...
          <section className="space-y-4">
            <h3 className="text-2xl font-bold text-emerald-400 border-b border-slate-700 pb-2">一、 陀螺基礎參數運作規則</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-slate-700/30 p-5 rounded-lg border border-slate-600">
                <h4 className="text-xl font-bold text-white mb-2">轉速 (Spin)</h4>
                <p className="text-slate-300 leading-relaxed text-lg">
                  陀螺的核心動力指標。轉速越高，機動性越強。發動技能或特殊攻擊（如衝刺）時會消耗轉速。此外，當陀螺遭受怪物或陷阱攻擊時，也會被扣減轉速值。轉速不會隨時間自然衰減，但若因受擊或過度衝刺降至過低，陀螺將失去攻擊與防禦能力。
                </p>
              </div>
              <div className="bg-slate-700/30 p-5 rounded-lg border border-slate-600">
                <h4 className="text-xl font-bold text-white mb-2">能量值 (Energy)</h4>
                <p className="text-slate-300 leading-relaxed text-lg">
              ...
              <div className="bg-slate-700/30 p-5 rounded-lg border border-slate-600">
                <h4 className="text-xl font-bold text-white mb-2">質量 (Mass)</h4>
                <p className="text-slate-300 leading-relaxed text-lg">
          ...
          <section className="space-y-4">
            <h3 className="text-2xl font-bold text-amber-400 border-b border-slate-700 pb-2">二、 碰撞目標破壞判定計算公式</h3>
            <p className="text-lg leading-relaxed text-slate-300 bg-slate-900/50 p-4 rounded border border-slate-800">
            ...
            <div className="bg-blue-900/20 p-4 rounded border border-blue-800/50 mt-4">
              <h4 className="text-blue-400 font-bold mb-1">💡 計算備註</h4>
              <ul className="list-disc pl-5 space-y-1 text-slate-300 text-base">
